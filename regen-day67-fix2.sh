#!/bin/bash
# Regen Day 67 slide7_instagram pass 2: avoid "EXACTLY" keyword, fix "sytonotic" typo
...
# Slide 7_instagram — pass 2: clean prompt, no instruction words in text
...
The card has two lines of large bold headline text at the top:
Line 1: BREATHE.
Line 2: HEAL.
Do NOT add any other words to the headline. No brackets. No codes. Just those two words.
Below the headline, leave a gap, then show this body text in medium bold:
Your immune system
is listening.
The word 'immune' is spelled i-m-m-u-n-e. The word 'system' is spelled s-y-s-t-e-m. Spell both correctly.
At the very bottom of the card in bold text: Follow @stillmeditation.app for Day 68
The handle is @stillmeditation.app — one word, no spaces, ends in .app"

echo ""
echo "=== Day 67 Regen Pass 2 Complete ==="
