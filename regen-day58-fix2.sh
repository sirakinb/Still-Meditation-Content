#!/bin/bash
# Regen Day 58 slide7_instagram pass 2 — avoid instruction words in prompts
...
# Slide 7_instagram pass 2
# Key fixes: no instruction words in text blocks; spell out breathwork carefully
...
Large bold left-aligned headline text at the top. The headline is two words: TEN MINUTES.
LEAVE A CLEAR GAP between headline and body.
Below in medium bold text, these lines (each line appears once):
That is all it takes
to move through a
complete breathwork flow.
Do it tonight.
NOTE: The word breathwork is spelled b-r-e-a-t-h-w-o-r-k. Do NOT write breadwork.
At the bottom in bold text: Follow @stillmeditation.app for Day 59"

echo ""
echo "=== Day 58 Regen Fix 2 Complete ==="
