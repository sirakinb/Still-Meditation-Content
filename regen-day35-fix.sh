#!/bin/bash
# Regenerate Day 35 slide 1 — fix duplicated "the biggest the biggest"
...
# Slide 1 — Hook (regen with shorter copy + explicit no-duplication instruction)
...
Render the text EXACTLY as written below. Do not duplicate any line. Do not repeat any word.
Large bold left-aligned headline text at the top reads:
5 WEEKS IN.
LEAVE A CLEAR GAP between headline and body.
Below in medium bold text, exactly three short lines:
You haven't noticed
the biggest
changes yet."
