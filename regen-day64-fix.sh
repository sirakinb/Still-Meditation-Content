#!/bin/bash
# Regen Day 64 broken slides: slide3 (typo) and slide5 (header artifact + garbled text)
...
# Slide 3 — The Inhale (fix: "forcefully" was misspelled as "forcefuly")
...
The header text at the top reads exactly: THE INHALE
...
Not a sip — a surge.
CRITICAL SPELLING: The word 'forcefully' has TWO letter L's: f-o-r-c-e-f-u-l-l-y. Do NOT write 'forcefuly' or 'forcfully'. Spell it: forcefully."

# Slide 5 — The Round (fix: header printed 'ALL-CAPS THE ROUND', body was garbled)
generate_slide 5 "Create a bold TikTok social media card illustration. ${STYLE}
Layout: Text occupies the LEFT 60%. Mascot on the FAR RIGHT, nothing in the left text zone.
The scene: The mascot sits in meditation pose with a calm counting gesture, focused relaxed expression showing control and rhythm.
The header text at the top reads exactly these two words: THE ROUND
LEAVE A CLEAR GAP between header and body.
EXACTLY these lines spelled correctly:
20 rapid breaths = 1 round.
Complete 3 rounds total.
Rest 30 to 60 seconds between.
Let your system settle.
CRITICAL: The header must say only 'THE ROUND' — two words, nothing else. Do NOT add any other words to the header."

echo ""
echo "=== Regen Day 64 Fix Complete ==="
