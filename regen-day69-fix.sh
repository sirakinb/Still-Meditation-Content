#!/bin/bash
# Regen Day 69 — fix slide 5 (nested mini-card) and slide 7 (leaked instruction text)
...
# Slide 5 — regen: remove nested mini-card, mascot must be part of same scene
generate_slide 5 "Create a bold TikTok social media card illustration. ${STYLE}
IMPORTANT: The mascot and background are part of ONE single unified scene. Do NOT put the mascot inside a frame, box, rounded rectangle, mini-card, or any inner border. There is only ONE card — the outer card. The mascot sits directly in the scene alongside the text.
...
# Slide 7 — CTA (TikTok variant): remove leaked instruction text
...
Show up tomorrow.
Ordinary is enough.
At the bottom in bold text, EXACTLY these words: Follow @stillmeditation for Day 70
The username MUST be spelled exactly: @stillmeditation (one word, do NOT duplicate the word still, do NOT add .app).
Only render these exact lines of text — do NOT add any other sentences or instructions as visible text."

echo ""
echo "=== Day 69 Regen Pass 1 Complete ==="
