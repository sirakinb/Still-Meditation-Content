#!/bin/bash
# Regen Day 67 slide7_instagram pass 3: fix "livstening" typo, add missing "is"
...
Headline at the top in large bold text, two lines only:
BREATHE.
HEAL.
Gap below headline.
Body text in medium bold — three words on three lines:
Your immune system
is listening.
Spelling check: l-i-s-t-e-n-i-n-g is the correct spelling of listening. Do NOT write livstening, listenning, or any other variant.
Bottom of card in bold: Follow @stillmeditation.app for Day 68"

echo ""
echo "=== Day 67 Regen Pass 3 Complete ==="
